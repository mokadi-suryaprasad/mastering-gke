...
gcloud container clusters get-credentials standard-cluster-private-1 --region us-central1 --project 
```
...
spec:
  accessModes:
    - ReadWriteMany
  storageClassName: filestore-storage-class   # ✅ Correct StorageClass
  resources:
    requests:
      storage: 1Ti
```
